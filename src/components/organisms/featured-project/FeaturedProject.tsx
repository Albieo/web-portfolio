  ...
  return (
    <section className="featured-project" id="featured-project">
      <div className="container">
        ...
        <p className="section__subtitle section__subtitle--featured">A highlight of my latest flagship work.</p>

        <div className="featured-project__content">
          <div className="featured-project__image-container">
            <img src={featuredImg} alt="Community Events Platform" className="featured-project__img" />
          </div>
          ...
          <div className="featured-project__info">
            ...
            <div className="featured-project__description">
              <p>
                A full-stack platform for managing community events and charity initiatives with real-time content updates.
              </p>
            ...
            <div className="featured-project__links">
              <a href="#" className="btn featured-project__btn--live">Live</a>
              <a href="#" className="btn btn--secondary featured-project__btn--github">GitHub</a>
            </div>
          </div>
        </div>
      </div>
